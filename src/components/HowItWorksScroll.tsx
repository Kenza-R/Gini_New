          ...
          {STEPS.map((step) => (
            ...
            >
              ...
              <img
                src={step.image}
                alt=""
                className={`absolute inset-0 h-full w-full object-cover ${step.cropClass ?? ""}`}
                style={
              ...
              <div className="relative z-10 flex h-full flex-col justify-end px-5 pb-14 sm:px-12 sm:pb-16 lg:px-16">
                ...
                <h3 className="mt-3 max-w-4xl font-sans text-[clamp(2.1rem,7vw,5.4rem)] leading-[0.92] font-extrabold tracking-[-0.045em] text-white uppercase drop-shadow-[0_2px_18px_rgba(0,0,0,0.45)]">
                  {step.title}
                </h3>
                <p className="mt-4 max-w-xl text-[15px] font-normal leading-[1.55] text-white/88 sm:text-[17px]">
                  {step.body}
                </p>
              </div>
            </article>
